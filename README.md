...
data.head()
resampled_data = data['#Passengers'].resample('YE').sum().to_frame()
resampled_data.head()
...
# OUTPUT
<img width="702" height="580" alt="2" src="https://github.com/user-attachments/assets/972632e3-34c1-4952-88aa-91e6136a459b" />
